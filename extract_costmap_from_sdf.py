...
def extract_costmap_from_sdf(sdf_path, output_txt="costmap.txt", resolution=1.0, size=8):
...
# Exemplo de uso
extract_costmap_from_sdf("maze_from_matrix_3.sdf", output_txt="base_maze.txt", resolution=1.0, size=8)